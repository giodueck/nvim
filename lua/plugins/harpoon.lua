...
vim.keymap.set("n", "<M-a>", function() harpoon:list():select(1) end, { desc = 'Harpoon: Go to first harpoon item' })
vim.keymap.set("n", "<M-s>", function() harpoon:list():select(2) end, { desc = 'Harpoon: Go to second harpoon item' })
vim.keymap.set("n", "<M-d>", function() harpoon:list():select(3) end, { desc = 'Harpoon: Go to third harpoon item' })
vim.keymap.set("n", "<M-f>", function() harpoon:list():select(4) end, { desc = 'Harpoon: Go to fourth harpoon item' })
vim.keymap.set("n", "<M-g>", function() harpoon:list():select(5) end, { desc = 'Harpoon: Go to fifth harpoon item' })
